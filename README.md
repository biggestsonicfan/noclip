...
whole of each chapter's table. Its enemy bodies and motions are not read yet.
Revision A (`hotd`) is a different program pair and is deliberately not accepted
as this set.
