 ...
 *
 * `tools/dl-verify.mjs` replays a *stage* list, where every part is placed by
 ...
 * `ik_2bone` arguments and `tools/test-motion-mame.mjs` compares those
 ...
 * `tools/test-motion-mame.mjs`, so taking them here is not circular -- what is
