...
angles, once a frame, so tools/test-canyon.mjs can be pointed at a real machine
...
Run:  claude_mame/mcp_server/.venv/Scripts/python.exe tools/mame-canyon-path.py <outdir> [rompath]
"""
