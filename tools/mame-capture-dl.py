...
drives claude_mame's bridge — see tools/mame-drive.py for why the bridge is
...
Run:  claude_mame/mcp_server/.venv/Scripts/python.exe tools/mame-capture-dl.py <outdir> [stage] [rompath]
"""
